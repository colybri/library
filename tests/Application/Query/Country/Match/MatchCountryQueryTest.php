...
final class MatchCountryQueryTest extends TestCase
{
    private $keywords;
    private $offset;
    private $limit;
    ...
    public function setUp(): void
    {
        ...
        $this->query = MatchCountryQuery::fromPayload(
            Uuid::v4(),
            [
                MatchCountryQuery::KEYWORDS_PAYLOAD => $this->keywords,
                MatchCountryQuery::OFFSET_PAYLOAD => $this->offset,
                MatchCountryQuery::LIMIT_PAYLOAD => $this->limit,
    ...
    {
        self::assertInstanceOf(MatchCountryQuery::class, $this->query);
    }
    ...
    public function given_null_country_id_when_query_is_invoke_then_throws_invalid_argument_exception(): void
    {
        ...
        MatchCountryQuery::fromPayload(
            Uuid::v4(),
            [
                MatchCountryQuery::KEYWORDS_PAYLOAD => null
            ]
        );
    }
}
